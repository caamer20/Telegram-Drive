...
Dùng JSONJava JNI chính thức từ `tdlib/td` commit `022d60202e446ad1287b9fb68e687c8a0760788b`; build OpenSSL 1.1.1w và `libtdjsonjava.so` bằng NDK 27.2/CMake 3.22.1 cho `arm64-v8a`, `x86_64`. Không dùng binary bên thứ ba.
